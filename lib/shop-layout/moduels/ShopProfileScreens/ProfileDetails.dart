                        ...
                        children: [
                          Stack(
                              ...
                              children:[
                                ...
                                ShopAppCubit.get(context).userdata!.image==''||ShopAppCubit.get(context).userdata!.image==null?
                                const CircleAvatar(backgroundImage: AssetImage('assets/icon/1.jpg'),radius: 80,):
                                CircleAvatar(backgroundImage: NetworkImage(ShopAppCubit.get(context).userdata!.image!),radius: 80,),
                                Container(
                                    width: 40,
                                    height: 40,
                          ...
                          Container(
                            ...
                            child: Row(
                              ...
                              children: [
                                Text(ShopAppCubit.get(context).userdata!.name!,
                          ...
                          Container(
                            ...
                            child: Row(
                              mainAxisAlignment: MainAxisAlignment.end,
                              children: [
                                Text(ShopAppCubit.get(context).userdata!.phone!=''?
                                ShopAppCubit.get(context).userdata!.phone!:'01501375000',
                                  style: const TextStyle(fontWeight: FontWeight.bold,fontSize: 18),),
                                Padding(
                                  padding: const EdgeInsets.only(left: 15.0),
                                  child: Container(   width: 40,height: 40,
                          ...
                          Container(
                            ...
                            child: Row(
                              mainAxisAlignment: MainAxisAlignment.end,
                              children: [
                                Text(ShopAppCubit.get(context).userdata!.email!,
                                  style: const TextStyle(fontWeight: FontWeight.bold,fontSize: 18),),
                                Padding(
                                  padding: const EdgeInsets.only(left: 15.0),
                                  child: Container(   width: 40,height: 40,
